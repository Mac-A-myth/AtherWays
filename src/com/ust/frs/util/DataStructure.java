...
public class DataStructure {
	...
	{
//		Cred.add(new CredentialsBean("Customer","Pass", "Customer", 1));
//		Cred.add(new CredentialsBean("Admin","word", "Administrator", 1));
		...
		Passenger.add(new PassengerBean("P001", "John Smith", "M", 29, 23));
		Passenger.add(new PassengerBean("P002", "Emily Johnson", "F", 34, 14));
		Passenger.add(new PassengerBean("P003", "Michael Williams", "M", 22, 5));
		Passenger.add(new PassengerBean("P004", "Sarah Brown", "F", 40, 3));
		Passenger.add(new PassengerBean("P005", "David Lee", "M", 26, 10));
		...
		Reservation.add(new ReservationBean("RES003", "Agent", "S003", "Round Trip", "2023-11-10", "2023-12-20", 3, 0, 650.90));
		Reservation.add(new ReservationBean("RES004", "Manager", "S004", "One Way", "2023-11-15", "2023-12-05", 1, 1, 200.30));
		Reservation.add(new ReservationBean("RES005", "Guest", "S005", "Round Trip", "2023-11-20", "2023-12-25", 4, 0, 850.00));
		...
		Schedule.add(new ScheduleBean("S006", "AI-002", "R6", "Mon,Wed,Thu", "05:00 PM", 8));
		Schedule.add(new ScheduleBean("S007", "JA-002", "R7", "Tue,Thu,Sat,Sun", "07:00 PM", 5));
