...
public class DataStructure {
    ...
    public DataStructure() {
        ...
        Flight.add(new FlightBean("AI-002", "Air India", 160, 130));
        Flight.add(new FlightBean("JA-002", "Jet Airways", 140, 115));
        
        // Initialize Passengers
        Passenger.add(new PassengerBean("RES001", "John Smith", "M", 29, 23));
        Passenger.add(new PassengerBean("RES001", "Jane Smith", "F", 27, 24));
        ...
        Passenger.add(new PassengerBean("RES003", "Sarah Williams", "F", 21, 6));
        ...
        Route.add(new RouteBean("R6", "Chicago", "Miami", 1800, 120000));
        Route.add(new RouteBean("R7", "Tokyo", "Seoul", 220, 55000));
        ...
        Reservation.add(new ReservationBean("RES003", "customer", "S003", "Round Trip", "2023-11-10", "2023-12-20", 2, 0, 650.90));
        Reservation.add(new ReservationBean("RES004", "customer", "S004", "One Way", "2023-11-15", "2023-12-05", 1, 1, 200.30));
        Reservation.add(new ReservationBean("RES005", "customer", "S005", "Round Trip", "2023-11-20", "2023-12-25", 1, 0, 850.00));
